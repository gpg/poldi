...
int poldi_scd_readkey (poldi_ctx_t ctx,
...
int poldi_scd_getinfo (poldi_ctx_t ctx,
		       const char *what,
		       char **result);

/* Reset the SCD if it has been used.  */
int poldi_scd_reset (poldi_ctx_t ctx);
